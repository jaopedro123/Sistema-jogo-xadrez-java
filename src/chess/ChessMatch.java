...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.equals("B") && !type.equals("C") && !type.equals("T") & !type.equals("Q")) {
			throw new InvalidParameterException("Peça digita e invalida!");
		}
	...
	private Piece makeMove(Position source, Position target) {
		...
		// #Movimento Especial CASTLING pela parte do rei
		...
		// #Movimento Especial CASTLING pela parte da Rainha
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("A peça escolhida não pode ser movida para posiçao que Você escolheu");
		}
	}
	...
	private ChessPiece King(Color color) {
		...
		throw new IllegalStateException("Não existe o rei" + color + "bo tabuleiro ");
	}
